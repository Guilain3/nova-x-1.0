...
const mockInvestorSettings: InvestorSettings = {
  id: 'inv-12345',
...
const SettingsPage: React.FC = () => {
  const [settings, setSettings] = useState<InvestorSettings>(mockInvestorSettings);
  const [isEditing, setIsEditing] = useState(false);
  const [tempSettings, setTempSettings] = useState<InvestorSettings>({ ...mockInvestorSettings });
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-blue-600 mt-2">Manage your investor profile</p>
        </div>
